...
<html>
    ...
    <body>
        <a class="btn btn-primary" href="http://localhost:8080/_web__war/Deliveryorder" role="button">返回接单</a>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="http://localhost:8080/_web__war/deliveryManself/update/${deliveryMan.deliveryManId}" method="get">
