...
public class OrderHistoryController {
    ...
    public void update1(@PathVariable Integer id, HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        System.out.println("进入update"+id);
        Order order = new Order();
        order.setOrderId(id);
        System.out.println("进入controller"+order);
    ...
    public void update2(@PathVariable Integer id, HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        System.out.println("进入update"+id);
        Order order = new Order();
        order.setOrderId(id);
        System.out.println("进入controller"+order);
